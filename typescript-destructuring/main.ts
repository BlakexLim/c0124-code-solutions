...
const { title: bookTitle, author: bookAuthor, libraryId: bookId } = book2;
console.log(
  `The title of the book is ${bookTitle}, the author is ${bookAuthor}, and the library id is ${bookId}`
);
